...
/** 作成リクエスト型 */
export type CreateHeadcountPlanCase = z.infer<typeof createHeadcountPlanCaseSchema>

/** 更新リクエスト型 */
export type UpdateHeadcountPlanCase = z.infer<typeof updateHeadcountPlanCaseSchema>

/** 一覧取得クエリ型 */
export type HeadcountPlanCaseListQuery = z.infer<typeof headcountPlanCaseListQuerySchema>
