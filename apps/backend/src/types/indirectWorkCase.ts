...
/** 作成リクエスト型 */
export type CreateIndirectWorkCase = z.infer<typeof createIndirectWorkCaseSchema>

/** 更新リクエスト型 */
export type UpdateIndirectWorkCase = z.infer<typeof updateIndirectWorkCaseSchema>

/** 一覧取得クエリ型 */
export type IndirectWorkCaseListQuery = z.infer<typeof indirectWorkCaseListQuerySchema>
