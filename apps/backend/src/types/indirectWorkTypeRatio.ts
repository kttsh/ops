...
/** 作成リクエスト型 */
export type CreateIndirectWorkTypeRatio = z.infer<typeof createIndirectWorkTypeRatioSchema>

/** 更新リクエスト型 */
export type UpdateIndirectWorkTypeRatio = z.infer<typeof updateIndirectWorkTypeRatioSchema>

/** バルク Upsert リクエスト型 */
export type BulkUpsertIndirectWorkTypeRatio = z.infer<typeof bulkUpsertIndirectWorkTypeRatioSchema>
