...
/** 作成リクエスト型 */
export type CreateChartViewIndirectWorkItem = z.infer<typeof createChartViewIndirectWorkItemSchema>

/** 更新リクエスト型 */
export type UpdateChartViewIndirectWorkItem = z.infer<typeof updateChartViewIndirectWorkItemSchema>
