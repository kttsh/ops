...
/** 一覧取得クエリスキーマ */
export const chartStackOrderSettingListQuerySchema =
...
/** 作成リクエスト型 */
export type CreateChartStackOrderSetting = z.infer<
	typeof createChartStackOrderSettingSchema
>;

/** 更新リクエスト型 */
export type UpdateChartStackOrderSetting = z.infer<
	typeof updateChartStackOrderSettingSchema
>;

/** 一括 Upsert リクエスト型 */
export type BulkUpsertChartStackOrderSetting = z.infer<
	typeof bulkUpsertChartStackOrderSettingSchema
>;

/** 一覧取得クエリ型 */
export type ChartStackOrderSettingListQuery = z.infer<
	typeof chartStackOrderSettingListQuerySchema
>;
