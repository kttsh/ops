...
export function toSummaryResponse(row: StandardEffortMasterRow): StandardEffortMasterSummary {
  return {
...
export function toWeightResponse(row: StandardEffortWeightRow): StandardEffortWeight {
  return {
