...
import { mockMonthlyHeadcounts, mockIndirectWorkRatios } from './__mocks__/data'

const months = Array.from({ length: 12 }, (_, i) => `2025${String(i + 4 > 12 ? i + 4 - 12 : i + 4).padStart(2, '0')}`)
...
const mockWorkTypes = [
  { workTypeCode: 'WT001', name: '基本設計', displayOrder: 1, color: '#3b82f6', createdAt: '2025-01-01T00:00:00Z', updatedAt: '2025-01-01T00:00:00Z' },
  { workTypeCode: 'WT002', name: '詳細設計', displayOrder: 2, color: '#10b981', createdAt: '2025-01-01T00:00:00Z', updatedAt: '2025-01-01T00:00:00Z' },
]

const meta = {
  title: 'Features/IndirectCaseStudy/ResultPanel',
