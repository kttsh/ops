          ...
          <thead>
            <tr className="border-b-2">
              ...
              {MONTH_LABELS.map((label) => (
                <th key={label} className="text-right py-2 px-2 font-medium text-muted-foreground whitespace-nowrap">
                  {label}
                </th>
              ))}
          ...
          <tbody>
            ...
            {isBreakdownExpanded &&
              rowData.breakdownRows.map((row) => (
                <tr key={row.workTypeCode} className="border-b hover:bg-muted/30">
