...
export const mockIndirectWorkRatios: IndirectWorkTypeRatio[] = [
  { indirectWorkTypeRatioId: 1, indirectWorkCaseId: 1, workTypeCode: 'WT001', fiscalYear: 2025, ratio: 0.15, createdAt: '2025-01-01T00:00:00Z', updatedAt: '2025-01-01T00:00:00Z' },
  { indirectWorkTypeRatioId: 2, indirectWorkCaseId: 1, workTypeCode: 'WT002', fiscalYear: 2025, ratio: 0.1, createdAt: '2025-01-01T00:00:00Z', updatedAt: '2025-01-01T00:00:00Z' },
...
export const mockCalculationTableData: CalculationTableData = {
  months,
  rows: [
    { label: '人員数', type: 'headcount', monthly: makeMonthly(20), annualTotal: 240 } satisfies CalculationTableRow,
    { label: 'キャパシティ (h)', type: 'capacity', monthly: makeMonthly(3200), annualTotal: 38400 } satisfies CalculationTableRow,
    { label: '基本設計 (15%)', type: 'indirect-breakdown', workTypeCode: 'WT001', monthly: makeMonthly(480), annualTotal: 5760 } satisfies CalculationTableRow,
    { label: '詳細設計 (10%)', type: 'indirect-breakdown', workTypeCode: 'WT002', monthly: makeMonthly(320), annualTotal: 3840 } satisfies CalculationTableRow,
    { label: '間接工数合計', type: 'indirect-total', monthly: makeMonthly(800), annualTotal: 9600 } satisfies CalculationTableRow,
  ],
}
