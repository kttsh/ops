...
import { fetchHeadcountPlanCases, fetchMonthlyHeadcountPlans } from './headcount-plan-client'
import { fetchCapacityScenarios, fetchMonthlyCapacities } from './capacity-scenario-client'
import {
  fetchIndirectWorkCases,
  fetchIndirectWorkTypeRatios,
  fetchMonthlyIndirectWorkLoads,
} from './indirect-work-client'
import type { HeadcountPlanCaseListParams } from '@/features/indirect-case-study/types'
import type { CapacityScenarioListParams } from '@/features/indirect-case-study/types'
import type { IndirectWorkCaseListParams } from '@/features/indirect-case-study/types'
...
export const indirectCaseStudyKeys = {
  ...
  monthlyCapacities: (scenarioId: number, bu?: string) =>
    [...indirectCaseStudyKeys.capacityScenarios(), scenarioId, 'monthly', bu] as const,
  ...
  monthlyIndirectWorkLoads: (caseId: number, bu?: string) =>
    [...indirectCaseStudyKeys.indirectWorkCases(), caseId, 'monthly-loads', bu] as const,
...
export function headcountPlanCasesQueryOptions(params: HeadcountPlanCaseListParams) {
  return queryOptions({
...
export function monthlyHeadcountPlansQueryOptions(caseId: number, businessUnitCode: string) {
  return queryOptions({
    queryKey: indirectCaseStudyKeys.monthlyHeadcountPlans(caseId, businessUnitCode),
...
export function capacityScenariosQueryOptions(params: CapacityScenarioListParams) {
  return queryOptions({
...
export function monthlyCapacitiesQueryOptions(scenarioId: number, businessUnitCode?: string) {
  return queryOptions({
    queryKey: indirectCaseStudyKeys.monthlyCapacities(scenarioId, businessUnitCode),
...
export function indirectWorkCasesQueryOptions(params: IndirectWorkCaseListParams) {
  return queryOptions({
...
export function monthlyIndirectWorkLoadsQueryOptions(caseId: number, businessUnitCode?: string) {
  return queryOptions({
    queryKey: indirectCaseStudyKeys.monthlyIndirectWorkLoads(caseId, businessUnitCode),
