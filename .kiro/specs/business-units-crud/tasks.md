...
- [ ] 2. 共通基盤（型定義・エラーハンドリング・バリデーション）
- [ ] 2.1 (P) RFC 9457 エラーハンドリング基盤の構築
...
- [ ] 2.2 (P) Zod バリデーションの RFC 9457 統合
...
- [ ] 2.3 (P) ビジネスユニットの Zod スキーマと型定義の作成
