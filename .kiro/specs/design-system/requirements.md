...
11. The Storybook shall `features/workload/components/FeedbackStates` のストーリーを含み、SkeletonChart、SkeletonTable、EmptyState、BuEmptyState、NoDataState、NoSearchResults、ErrorState、OverlaySpinner の全8コンポーネントを個別のストーリーとして確認できること
